  ...
  >
    <section class="u-clearfix u-grey-80 u-section-1" id="block-3">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        />
        <h1 class="u-text u-text-1">casa bianca</h1>
        <p class="u-text u-text-default u-text-2">Description de votre restaurant :</p>
        ...
        <p class="u-text u-text-4">Résumé de votre restaurant :</p>
        <p class="u-text u-text-5">
          La meilleure pizzeria de votre quartier. Venez découvrir nos différents repas
        </p>
        <a
          href=""
        ...
        <span
          ...
          ><svg
            ...
            style=""
          >
            <use xlink:href="#svg-f4a7"></use></svg
          ><svg
            class="u-svg-content"
            viewBox="0 0 55.25 55.25"
            x="0px"
	...
	l-3.183,0.354L34.94,10.409l9.9,9.9L17.157,47.992L17.511,44.809z M49.082,16.067l-9.9-9.9l1.415-1.415l9.9,9.9L49.082,16.067z"
            ></path></svg></span
        ><span
          class="u-border-2 u-border-palette-1-base u-icon u-icon-circle u-text-palette-1-base u-icon-2"
          ><svg
            class="u-svg-link"
            preserveAspectRatio="xMidYMin slice"
            viewBox="0 0 55.25 55.25"
            style=""
          >
            <use xlink:href="#svg-7253"></use></svg
          ><svg
            class="u-svg-content"
            viewBox="0 0 55.25 55.25"
            x="0px"
...
.u-section-1 .u-text-3 {
  margin: 0 45px 0 425px;
}

.u-section-1 .u-text-4 {
  font-size: 1.875rem;
  margin: -262px 717px 0 0;
}

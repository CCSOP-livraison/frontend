                  ...
                  <div class="u-container-layout u-container-layout-2">
                    <span class="u-icon u-icon-1"
                      ><svg
                        ...
                        viewBox="0 0 50 50"
                      >
                        <use xlink:href="#svg-4b1d"></use></svg
                      ><svg
                  ...
                  <div class="u-container-layout u-container-layout-4">
                    <span class="u-icon u-icon-2"
                      ><svg
                        ...
                        viewBox="0 0 58 58"
                      >
                        <use xlink:href="#svg-de5b"></use></svg
                      ><svg class="u-svg-content" viewBox="0 0 58 58" x="0px" y="0px" id="svg-de5b">
                        <path
                          style="fill: #7383bf"
                ...
                <div class="custom-expanded u-container-style u-grey-10 u-group u-group-3">
                  <div class="u-container-layout u-container-layout-6">
                    <span class="u-icon u-icon-3"
                      ...
                      >
                        <use xlink:href="#svg-d492"></use></svg
                      ><svg
                        class="u-svg-content"
                        viewBox="0 0 53.867 53.867"
                        x="0px"
...
.u-section-1 .u-icon-3 {
  width: 132px;
  height: 132px;
  color: rgb(239, 206, 74) !important;
  margin: 14px auto 0;
  padding: 0;
}

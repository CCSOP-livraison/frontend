      ...
      <div class="u-clearfix u-sheet u-sheet-1">
                  ...
                  <div class="u-container-layout u-container-layout-2">
                    <span class="u-icon u-icon-1"
                      ><svg
                        ...
                        style=""
                      >
                        <use xlink:href="#svg-8ead"></use></svg
                      ><svg
                        class="u-svg-content"
                        viewBox="0 0 55.25 55.25"
                        x="0px"
		...
		c0.391-0.391,0.391-1.023,0-1.414s-1.023-0.391-1.414,0L10.44,37.738l-3.183,0.354L34.94,10.409l9.9,9.9L17.157,47.992z
		 M46.254,18.895l-9.9-9.9l1.414-1.414l9.9,9.9L46.254,18.895z M49.082,16.067l-9.9-9.9l1.415-1.415l9.9,9.9L49.082,16.067z"
                    ...
                    <a
                      ...
                      >créer un compte adminstrateur ou modérateur
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="u-container-layout u-container-layout-4">
                    <span class="u-icon u-icon-2"
                      ><svg
                        ...
                        style=""
                      >
                        <use xlink:href="#svg-65aa"></use></svg
                      ><svg
                        class="u-svg-content"
                        viewBox="0 0 51.976 51.976"
                        x="0px"
		...
		l-7.071,7.071l7.425,7.425C37.022,34.194,37.022,35.46,36.241,36.241z"
                    ...
                    <a
                      ...
                      >supprimer un compter administrateur ou modérateur
                    </a>
                  </div>
                </div>
              </div>
